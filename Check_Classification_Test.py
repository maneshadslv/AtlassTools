...
def main():
    ...
    if args.command == 'CHECKFILES':
        ...
        rec_filelist = AtlassGen.FILELIST([f'*.{filetype}'],recfolder)
        ori_filelist = AtlassGen.FILELIST([f'*.{filetype}'],orifolder)
        ...
        df = df[['Classification','Classification Test','Status']]
