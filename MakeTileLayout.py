...
def param_parser():
    ...
    main_parser.add_argument("filetype",metavar="Input File Type", help="Select input file type", choices=['las', 'laz','zip','rar','txt','asc','shp','tif'], default='laz')
    ...
    lastedit_parser.add_argument('filetype',metavar="Input File Type", help="Select input file type", choices=['las', 'laz','zip','rar','txt','asc'], default='laz')
...
def main():
    ...
    if args.command=='main':
        ...
        for file in files:
            ...
            tilelayout.addtile(name=tilename, xmin=float(x), ymin=float(y), xmax=float(x)+tilesize, ymax=float(y)+tilesize, modtime=modificationTime)
